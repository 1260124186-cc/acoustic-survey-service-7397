# acoustic-survey-service__009 Docker 交付说明
...
```bash
./build_benzhi_docker.sh acoustic-survey-service__009-benzhi linux/amd64
docker run --rm -it acoustic-survey-service__009-benzhi bash
```
...
- 代码目录: `/app`
- 源码中检测到的服务端口: `10`, `20`, `30`, `18087`, `38000`
