# acoustic-survey-service__011 Docker 交付说明
...
```bash
./build_benzhi_docker.sh acoustic-survey-service__011-benzhi linux/amd64
docker run --rm -it acoustic-survey-service__011-benzhi bash
```
...
- 代码目录: `/app`
- 源码中检测到的服务端口: `30`, `18087`, `37000`, `38000`
