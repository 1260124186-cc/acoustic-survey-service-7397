# acoustic-survey-service__004 Docker 交付说明
...
```bash
./build_benzhi_docker.sh acoustic-survey-service__004-benzhi linux/amd64
docker run --rm -it acoustic-survey-service__004-benzhi bash
```
